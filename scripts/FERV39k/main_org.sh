...
min_lr=1e-4 #1e-5
epochs=100 # 300
# model_checkpoint="./saved/model/finetuning/${finetune_dataset}/FERV39k_org/eval_split0${splits}/checkpoint-best.pth" #

for split in "${splits[@]}";
    do
      OUTPUT_DIR="./saved/model/finetuning/${finetune_dataset}/FERV39k_org_train/eval_split0${split}"
