...
# from kinetics_t import VideoClsDataset, VideoMAE, VideoClsDatasetFrame
# from kinetics_16f import VideoMAE, VideoClsDatasetFrame
...
def build_dataset(is_train, test_mode, args):
    ...
    # me: new added
        ...
        dataset = VideoClsDatasetFrame(
            ...
            num_crop=1 if not test_mode else 3,
            keep_aspect_ratio=True,
            crop_size=args.input_size, #112
            short_side_size=args.short_side_size, # 112
