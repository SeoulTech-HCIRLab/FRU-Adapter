...
class LayerDecayValueAssignerForAudioVisual(object):
    def __init__(self, values, num_modality_specific_layers):
        self.values = values
        self.num_modality_specific_layers = num_modality_specific_layers

    def get_scale(self, layer_id):
        return self.values[layer_id]

    def get_layer_id(self, var_name):
        return get_num_layer_for_avit(var_name, len(self.values), self.num_modality_specific_layers)
